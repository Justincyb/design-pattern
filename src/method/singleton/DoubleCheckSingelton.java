...
public class DoubleCheckSingelton {
    ...
    private volatile static DoubleCheckSingelton doubleCheckSingelton;

    // 全局唯一访问入口
    public static DoubleCheckSingelton getDoubleCheckSingelton() {
        if (doubleCheckSingelton == null) {
            synchronized (DoubleCheckSingelton.class) {
                if (doubleCheckSingelton == null) {
                    doubleCheckSingelton = new DoubleCheckSingelton();
                }
            }
        }
    ...
    public static void main(String[] args) {
        ...
        Thread t1 = new Thread(() -> {
            DoubleCheckSingelton doubleCheckSingelton = DoubleCheckSingelton.getDoubleCheckSingelton();
